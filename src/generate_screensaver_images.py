...
def process_images(
    ...
    blue_items = [2, 3, 10, 12, 13, 14, 15, 16, 17, 37, 38, 42, 47, 48, 49, 50, 117, 119, 130, 131, 133, 134, 135, 136,
                  137, 138, 139]
    purple_items = [4, 5, 6, 8, 9, 11, 18, 19, 20, 21, 22, 23, 24, 25, 26, 35, 40, 43, 44, 45, 46, 108, 109, 113, 122, 123,
                    124, 125, 127, 141, 142]
    orange_items = [7, 27, 28, 33, 34, 36, 39, 41, 85, 90, 94, 96, 97, 118, 120, 121, 128, 129, 132, 140]
